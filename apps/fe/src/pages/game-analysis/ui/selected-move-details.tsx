      ...
      <CardContent className="space-y-6">
        ...
        <div className="border-border bg-surface-subtle rounded-[22px] border px-4 py-4">
          ...
          <p className="text-muted-foreground mt-2 text-sm leading-6">
            Переключатель «До хода / После хода» продолжает показывать позицию
            вокруг выбранного ply, а подробные рекомендации появляются только
            для отмеченных критических моментов.
          </p>
        </div>
      </CardContent>
    </Card>
